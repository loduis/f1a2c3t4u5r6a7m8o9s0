<?php/*
$métodos         = openssl_get_md_methods();
...
$hex = hex2bin("302c0201013021300906052b0e03021a05000414");
var_dump($hex);
...
$data = openssl_x509_parse(file_get_contents('certificados_rais/3.crt'));
...
$publicKey = 'certificados_rais/3.crt';
