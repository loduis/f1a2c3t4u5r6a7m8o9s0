                ...
                success: function (data, message, xhr) {
                    ...
                    if(s.returnType == "json" && $.type(data) == "object" && data.hasOwnProperty(s.customErrorKeyStr)) {
                        ...
                        if(s.showStatusAfterError) {
                            pd.progressDiv.hide();
                            pd.statusbar.append("<span class='" + s.errorClass + "'>ERRORs: " + msg + "</span>");
                        } else {
                            pd.statusbar.hide();
                            pd.statusbar.remove();
                        }
                ...
                error: function (xhr, status, errMsg) {
                    ...
                    if(xhr.statusText == "abort") //we aborted it
                    {
                        ...
                        if(status == "parseerror")
                        {
                            if(s.showStatusAfterError) {
                                pd.progressDiv.hide();
                                pd.statusbar.append("<span class='" + s.errorClass + "'>ERRORx: " + errMsg + "</span>");
                            } else {
                                pd.statusbar.hide();
                                pd.statusbar.remove();
                            }
                        ...
                        else
                        {
                            ...
                            pd.progressbar.width('100%');
                            pd.progressbar.html('100%');
                            pd.statusbar.append("<div class='ajax-file-upload-green'>ENVIADO</div>");
                        }
