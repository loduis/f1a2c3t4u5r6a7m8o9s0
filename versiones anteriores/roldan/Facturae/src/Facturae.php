...
class Facturae {
  ...
  public function sign($publicPath, $privatePath=null, $passphrase="", $policy=self::SIGN_POLICY_3_1) {
    ...
    // Generate random IDs
    $this->signatureID                 = '16baa8f6-2e89-4ff9-b736-7e642ce066c3'; //$this->random();
    $this->signedInfoID                = $this->random();
    $this->signedPropertiesID          = $this->random();
    $this->signatureValueID            = '16baa8f6-2e89-4ff9-b736-7e642ce066c3';//$this->random();
    $this->certificateID               = '16baa8f6-2e89-4ff9-b736-7e642ce066c3';//$this->random();
    $this->referenceID                 = '16baa8f6-2e89-4ff9-b736-7e642ce066c3';//$this->random();
